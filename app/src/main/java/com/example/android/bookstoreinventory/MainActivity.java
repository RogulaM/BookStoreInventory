...
public class MainActivity extends AppCompatActivity implements
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        // Inflate the menu_editor options from the res/menu_editor/menu_catalog.xml file.
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            // Respond to a click on the "Delete all entries" menu_editor option
            case R.id.action_remove_all_entries:
    ...
    private void showDeleteConfirmationDialog() {
        ...
        builder.setMessage(R.string.remove_all_products_dialog_msg);
